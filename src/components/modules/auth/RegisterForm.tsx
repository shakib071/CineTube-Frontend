...
import { registerAction } from "@/app/(commonLayout)/(authRoutes)/register/_action";
      ...
      <Card className="bg-zinc-900/80 border-white/10 backdrop-blur-sm shadow-2xl shadow-black/60">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription className="text-white/50">
            Start your free trial with CineTube
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="pt-4">
              ...
              {(field) => (
                <AppField
                  ...
                  append={
                    ...
                    >
                      {showPassword ? <EyeOff className="text-black w-4 h-4" /> : <Eye className="text-black  w-4 h-4" />}
                    </Button>
                  }
                />
              )}
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-zinc-900 text-white/30">or continue with</span>
            </div>
          </div>
